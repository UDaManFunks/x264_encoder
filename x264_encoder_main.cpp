...
StatusCode X264EncoderMain::s_GetEncoderSettings(HostPropertyCollectionRef* p_pValues, HostListRef* p_pSettingsList)
{
...
StatusCode X264EncoderMain::s_RegisterCodecs(HostListRef* p_pList)
{
	// add x264 encoder
